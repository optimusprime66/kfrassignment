    ...
    _createClass(Block, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "button",
                    { onClick: this.handleAverageAction },
                    "Vote+0"
                )
            );
        }
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement("br", null),
                    "Review :",
                    React.createElement("input", { type: "text/string", "class": "col-xs-2", id: "ex2", name: "review", placeHolder: "Write Item Personal Review" }),
                    React.createElement("br", null),
                    React.createElement(
                        "button",
...
var App = function (_React$Component5) {
    ...
    _createClass(App, [{
        ...
        value: function clearForm() {
            ...
            var price = event.target.elements.review.value;
        ...
        value: function render() {
            return React.createElement(
                "div",
                { id: "Title" },
                React.createElement(Header, { title: "My Food Review" }),
                React.createElement(FormElement, { clearForm: this.clearForm }),
                React.createElement(Header, { title: "List Of All The Good Items Foods Of Mine " }),
